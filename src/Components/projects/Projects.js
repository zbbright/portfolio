...
function Projects(props){
    return (<div className='projects jumbotron m-4 bg-white p-3 opacity-1'>
        ...
        <p>For an example of vanilla Javascript coding, check out my Monty Hall simulator. <a href="https://zbbright.github.io/montyhall/">Github page</a>|<a href="https://github.com/zbbright/monyhall">Github repo</a></p>
